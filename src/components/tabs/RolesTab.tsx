import { Users, Shield, Crown, User, UserCheck, AlertTriangle } from 'lucide-react';
 ...
 */
export function RolesTab({ roleData, selectedAuthority, onClearSelection }: RolesTabProps) {
  ...
  const getRoleIcon = (roleType: string): LucideIcon => {
    switch (roleType) {
        ...
        <div className="space-y-6">
                      ...
                      {role.ansvarsomrader && role.ansvarsomrader.length > 0 && (
                        <div className="mt-3 pt-3 border-t border-gray-200">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {role.ansvarsomrader.map((område: string, idx: number) => (
          ...
          {inactiveRoles.length > 0 && (
            <div>
              ...
              <div className="space-y-4">
                {inactiveRoles.map((role: any, index: number) => {
                  const RoleIcon = getRoleIcon(role.rolle);
                  return (
                    <div 
                      key={`inactive-${index}`} 
