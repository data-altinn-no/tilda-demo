 ...
 */
export function VehiclesTab({ vehicleData, selectedAuthority, onClearSelection }: VehiclesTabProps) {
  ...
  const getOwnershipColor = (isOwner: boolean): string => {
    return isOwner 
  ...
  const isEUControlOverdue = (nextControlDate?: string): boolean => {
