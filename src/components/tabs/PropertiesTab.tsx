import { Building2, DollarSign, Landmark, Home } from 'lucide-react';
 ...
 */
export function PropertiesTab({ propertyData, selectedAuthority, onClearSelection }: PropertiesTabProps) {
  ...
  const getTotalTeigArea = (teigarealer?: number[]): number => {
      ...
      <CardContent>
        <div className="space-y-6">
          {propertyData.map((property: any, index: number) => {
            ...
            const totalMortgageAmount = property.pantedokumenter?.reduce((sum: number, doc: any) => {
                ...
                {property.grunnboksinformasjon?.teigarealer && property.grunnboksinformasjon.teigarealer.length > 0 && (
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {property.grunnboksinformasjon.teigarealer.map((area: number, idx: number) => (
                ...
                {property.pantedokumenter && property.pantedokumenter.length > 0 && (
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <div className="space-y-2">
                      {property.pantedokumenter.map((doc: any, docIdx: number) => (
