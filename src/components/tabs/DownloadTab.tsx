...
import { downloadCSV, downloadJSON, flattenBruddByMyndighet } from '../../utils/exportHelpers';
...
export function DownloadTab({ 
  ...
  const filteredMeldinger = selectedAuthority && meldinger ? meldinger.filter(m => m.mottaker === selectedAuthority) : (meldinger || []);
