 ...
 */
export function DetailedBox({ title, rows, selectedAuthority, onClearSelection }: DetailedBoxProps) {
        ...
        {filteredEntries.map(([mynd, items]) => {
          ...
          return (
            ...
            <ul className="text-sm grid gap-1">
              {items.slice(0,5).map((r: any, idx: number) => {
